...
│   ├── dermassist.db                 ← SQLite database file (auto-created on first run)
...
│       │   └── Safety.jsx            ← Safety & disclaimer page
│       └── components/
│           ├── Navbar.jsx            ← Top navigation with user avatar + logout
│           ├── Footer.jsx            ← Site footer
│           ├── UploadCard.jsx        ← Image upload + live camera capture
│           ├── ResultCard.jsx        ← AI result with human-friendly message
│           ├── ExplainableAI.jsx     ← Why the AI made that decision
│           ├── RecommendationPanel.jsx ← Next steps based on risk level
│           ├── ProcessingLoader.jsx  ← Animation shown while AI is analyzing
│           └── SevenClassesOrbit.jsx ← Interactive 7-class lesion diagram
│
├── README.md                         ← This file
├── README1.md                        ← Additional notes
├── SETUP.md                          ← Setup instructions
└── setup.html                        ← HTML setup guide
```
